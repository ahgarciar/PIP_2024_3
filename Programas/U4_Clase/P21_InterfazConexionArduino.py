import serial  # PARA PODER CONECTAR A ARDUINO
import sys
...
class MyApp(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    #Area de Slots
    def accion(self):
        texto_boton = self.btn_accion.text() # nombre del boton
        com = "COM" + self.txt_com.text() #obtiene el com al que se conectara .--->
